select src.host as ip_src, dst.host as ip_dst, psrc.port as port_src, pdst.port as port_dst, prot.protocol as protocol, r.policy as action, r.handle as handle,  r.id as rule_id, chains.hook, chains.name as chain, tables.name as "table", tables.family
from rules r
